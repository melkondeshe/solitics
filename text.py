...
underperform_and_total_assessment_lower_than_50 = ['terrible', 'horrible', 'very bad', 'inadequate']
negative = ['disappointing', 'inferior', 'very bad', 'unsatisfactory', 'poor', 'terrible', 'horrible', 'very bad', 'inadequate']
hold = ['medicare', 'not very impressive', 'fair', 'average']
neutral = ['medicare', 'not very', 'impressive', 'fair', 'average']

def my_portfolio_text(**kwargs):
    version =  {
        'my_portfolio_1_1' : f"{kwargs['company_name']} which is part of your portfolio has just released a {kwargs['positive_adjective']} {kwargs['report_type']} report with very {kwargs['positive_adjective']} fundamentals compeared to their pervious report which was {kwargs['negative_adjective']}, the new report places {kwargs['company_name']} in the top {kwargs['percent']}% relative to all its competitors. [CTA]",
        'my_portfolio_1_2' : f"{kwargs['company_name']} which is part of your portflio has just released a {kwargs['positive_adjective']} {kwargs['report_type']} report with {kwargs['positive_adjective']} fundamentals following the pervious report, which was also {kwargs['positive_adjective']} which places {kwargs['company_name']} in the top {kwargs['percent']}% relative to all its competitors. [CTA]",
        'my_portfolio_1_3' : f"{kwargs['company_name']} which is part of your portfolio has just released a {kwargs['positive_adjective']} {kwargs['report_type']} report with {kwargs['positive_adjective']} fundamentals that place {kwargs['company_name']} in the top {1/5/10}% relative to all its competitors. [CTA]",
        ...
        'my_portfolio_1_5' : f"{kwargs['company_name']} which is part of your portfolio has just released {kwargs['negative_adjective']} {kwargs['report_type']} report with {kwargs['negative_adjective']} fundamentals compared pervious report, which was {kwargs['positive_adjective']}. Unfortunately the new report places {kwargs['company_name']} in the bottom {kwargs['percent']}% relative to all its competitors. [CTA]",
        'my_portfolio_1_6' : f"{kwargs['company_name']} which is part of your portfolio has just released {kwargs['negative_adjective']} {kwargs['report_type']} report with {kwargs['negative_adjective']} fundamentals which places {kwargs['company_name']} in the bottom {kwargs['percent']}% relative to all its competitors. [CTA]",
        'my_portfolio_1_7' : f"{kwargs['company_name']} which is part of your portfolio has just released a {kwargs['positive_adjective']} {kwargs['report_type']} report, compared to their previous report which was {kwargs['negative_adjective']}. One of the figures to be noted is their {kwargs['most_positive_param_name']}, which {kwargs['increased_decreased']} by {kwargs['most_positive_param_pct']}%, which historically have a {kwargs['most_positive_param_coeff']} chance of impacting the stock price.",
        'my_portfolio_1_8' : f"{kwargs['company_name']} which is part of your portfolio has just released a {kwargs['positive_adjective']} {kwargs['report_type']} report, like their previous report which was also {kwargs['negative_adjective']}. This trend which has continued for the last {kwargs['number_of_last_buy_and_strongbuy_in_a_row']} quarters indicates for strong and solid fundamentals. [CTA]",
        'my_portfolio_1_9' : f"{kwargs['company_name']} which is part of your portfolio has just released a {kwargs['negative_adjective']} {kwargs['report_type']} report compared to the previous report, which was {kwargs['positive_adjective']}. It's a warning sign might indicate that a negative trend may be starting. [CTA]",
